...
import inputStaticColors from './input-static-colors';
import inputStaticLabelColors from './input-static-label-colors';

export const InputStaticTheme: IPropsMapper<object> = {
  input: {
  ...
  variantColor: inputStaticColors,
  labelColor: inputStaticLabelColors,
  label: {
    position: '-top-2.5',
